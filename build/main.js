...
})({"ioiEd":[function(require,module,exports) {
...
var _mapGen = require("./engine/map_gen");
...
var _itemGen = require("./engine/item_gen");
...
class Game {
    ...
    constructor(canvas, level, assets){
        ...
        this.ecs.addComponent(this.player, _components.ImageComponent, [
            this.getImage("player"),
            new (0, _helpers.Rect)(0, 0, 16, 16)
        ]);
        // put the player in the middle of the room
        this.ecs.addComponent(this.player, _components.PositionComponent, [
            new (0, _helpers.Vec)((this.roomSize.x / 2 - .5) * this.tileSize, (this.roomSize.y / 2 - .5) * this.tileSize),
            this.room
        ]);
        this.ecs.addComponent(this.player, _components.SpeedComponent, [
            this.tileSize / 28
        ]); // move 1/20 of a tile per frame
        this.ecs.addComponent(this.player, _components.WalkingComponent);
        this.ecs.addComponent(this.player, _components.ControllableComponent);
        this.ecs.addComponent(this.player, _components.HandsComponent, [
            null,
            null
        ]);
        this.ecs.addComponent(this.player, _components.HealthComponent, [
            100
        ]);
        this.ecs.addComponent(this.player, _components.HitboxComponent, [
    ...
    getAudio(name) {
        const audio = this.getAsset(name);
        audio.volume = 1; // lower default volume
        return audio;
    }
}
...
},{"./components":"hVzNr","./systems/controllable":"6hz4e","./engine/ecs":"bTIAG","./systems/render":"lpuAS","./helpers":"e7qJp","./systems/walking":"jMNjN","@parcel/transformer-js/src/esmodule-helpers.js":"b4oyH","./systems/place":"5rRAM","./systems/keyup":"gd8Fk","./systems/hit":"1OXJn","./systems/weapon":"el55c","./engine/map_gen":"3JMAi","./systems/health_bar":"eAFUA","./engine/item_gen":"gFSPB","./engine/asset_loader":"lAt7z"}],"hVzNr":[function(require,module,exports) {
/* 
 * components.ts
 *
...
const anyHitboxesCollide = (game, entity, room = game.currentRoom)=>{
...
},{"../components":"hVzNr","../engine/ecs":"bTIAG","../helpers":"e7qJp","@parcel/transformer-js/src/esmodule-helpers.js":"b4oyH"}],"1OXJn":[function(require,module,exports) {
/* 
 * systems/hit.ts
 *
...
},{"../components":"hVzNr","../engine/ecs":"bTIAG","../helpers":"e7qJp","@parcel/transformer-js/src/esmodule-helpers.js":"b4oyH"}],"el55c":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../components":"hVzNr","../engine/ecs":"bTIAG","@parcel/transformer-js/src/esmodule-helpers.js":"b4oyH"}],"3JMAi":[function(require,module,exports) {
/* 
 * engine/mapgen.ts
 *
...
},{"../components":"hVzNr","../helpers":"e7qJp","@parcel/transformer-js/src/esmodule-helpers.js":"b4oyH"}],"eAFUA":[function(require,module,exports) {
/* 
...
},{"../components":"hVzNr","../engine/ecs":"bTIAG","@parcel/transformer-js/src/esmodule-helpers.js":"b4oyH"}],"gFSPB":[function(require,module,exports) {
/* 
 * engine/itemgen.ts
 *
...
var _components = require("../components");
var _helpers = require("../helpers");
const newItem = (game, room, image, frame, hitbox)=>{
    ...
    game.ecs.addComponent(entity, _components.HitboxComponent, [
        hitbox ?? new (0, _helpers.Rect)(0, 0, game.tileSize, game.tileSize)
    ]);
    let pixelPos;
    do {
        // set position on tile grid then add random offset
        pixelPos = new (0, _helpers.Vec)(((0, _helpers.randInt)(2, game.roomSize.x - 3) + Math.random() - .5) * game.tileSize, ((0, _helpers.randInt)(2, game.roomSize.y - 3) + Math.random() - .5) * game.tileSize);
        game.ecs.addComponent(entity, _components.PositionComponent, [
            pixelPos,
            room.pos
        ]);
    }while ((0, _helpers.anyHitboxesCollide)(game, entity, room));
    // if no hitbox was provided, remove the temporary one
    if (!hitbox) game.ecs.componentManagers.get(_components.HitboxComponent).removeComponent(entity);
...
const addItems = (game)=>{
    for (const room of game.rooms)// 5-10 logs in each room
    for(let i = 0; i < (0, _helpers.randInt)(5, 10); i++)newItem(game, room, game.getImage("items"), new (0, _helpers.Rect)(0, 0, 16, 16), new (0, _helpers.Rect)(1, 1, game.tileSize - 1, game.tileSize - 1));
    // add a stick in the room the player starts in
    const stick = newItem(game, game.currentRoom, game.getImage("items"), new (0, _helpers.Rect)(0, 16, 16, 16));
    game.ecs.addComponent(stick, _components.WeaponComponent, [
        5
    ]);
};

},{"../components":"hVzNr","../helpers":"e7qJp","@parcel/transformer-js/src/esmodule-helpers.js":"b4oyH"}],"lAt7z":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"b4oyH"}]},["ioiEd","2G5F2"], "2G5F2", "parcelRequirec2fe")

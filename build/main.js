...
var _controllableDefault = parcelHelpers.interopDefault(_controllable);
var _walking = require("./systems/walking");
var _walkingDefault = parcelHelpers.interopDefault(_walking);
...
var _placeDefault = parcelHelpers.interopDefault(_place);
var _keyup = require("./systems/keyup");
var _keyupDefault = parcelHelpers.interopDefault(_keyup);
var _healthBar = require("./systems/health_bar");
var _healthBarDefault = parcelHelpers.interopDefault(_healthBar);
var _weapon = require("./systems/weapon");
var _weaponDefault = parcelHelpers.interopDefault(_weapon);
var _follow = require("./systems/follow");
var _followDefault = parcelHelpers.interopDefault(_follow);
var _click = require("./systems/click");
var _clickDefault = parcelHelpers.interopDefault(_click);
var _particles = require("./systems/particles");
var _particlesDefault = parcelHelpers.interopDefault(_particles);
// imports from the engine
var _assetLoader = require("./engine/asset_loader");
var _ecs = require("./engine/ecs");
var _entityGen = require("./entity_gen");
// misc imports
var _player = require("./templates/player");
var _mapGen = require("./map_gen");
var _helpers = require("./helpers");
var _respawn = require("./systems/respawn");
var _respawnDefault = parcelHelpers.interopDefault(_respawn);
var _hunt = require("./systems/hunt");
var _huntDefault = parcelHelpers.interopDefault(_hunt);
class Game {
    ...
    constructor(canvas, level, assets){
        ...
        this.player = (0, _player.newPlayerEntity)(this, new (0, _helpers.Vec)((this.roomSize.x / 2 - .5) * this.tileSize, (this.roomSize.y / 2 - .5) * this.tileSize));
        // add boxes to show items held by the player
        [this.leftHandItemBox, this.leftHandItemPos] = this.addItemBox(new (0, _helpers.Vec)(this.tileSize, (this.roomSize.y - 4) * this.tileSize));
        [this.rightHandItemBox, this.rightHandItemPos] = this.addItemBox(new (0, _helpers.Vec)((this.roomSize.x - 4) * this.tileSize, (this.roomSize.y - 4) * this.tileSize));
        // generate the rooms using the function in mapgen.ts
        this.rooms = (0, _mapGen.generateMap)(this);
        // add items to the rooms
        (0, _entityGen.addEntities)(this);
        for (const room of this.rooms)// bring all walking entities to the front
        this.ecs.entitiesWithComponents(room, [
            _components.WalkingComponent
        ]).forEach(this.ecs.bringToFront, this.ecs);
        // add systems
        [
            // systems that set speeds
            (0, _controllableDefault.default),
            (0, _followDefault.default),
            // system that moves them
            (0, _walkingDefault.default),
            // input systems
            (0, _clickDefault.default),
            (0, _keyupDefault.default),
            (0, _placeDefault.default),
            // misc systems
            (0, _respawnDefault.default),
            (0, _huntDefault.default),
            // systems that render things
            (0, _renderDefault.default),
            (0, _healthBarDefault.default),
            (0, _weaponDefault.default),
            (0, _particlesDefault.default)
    ...
    addItemBox(pos) {
        ...
        return [
            itemBox,
            pos.shifted(new (0, _helpers.Vec)(this.tileSize, this.tileSize))
        ];
    }
    ...
    get playerRoomPos() {
        return this.ecs.getComponent(this.player, _components.PositionComponent).room;
    }
    roomAt(pos) {
        return this.rooms.find((room)=>(0, _helpers.Vec).equal(room.pos, pos));
    }
    getAsset(name) {
        const assetArray = [];
        for(const assetSubArr in this.assets)assetArray.push(...this.assets[assetSubArr]);
...
const assetLoader = new (0, _assetLoader.AssetLoader)([
    ...
    {
        type: (0, _assetLoader.AssetType).Image,
        path: "assets/images/items.png"
    },
    {
        type: (0, _assetLoader.AssetType).Image,
        path: "assets/images/item_box.png"
    },
    {
        type: (0, _assetLoader.AssetType).Image,
        path: "assets/images/zombie.png"
    },
    {
    ...
    {
        type: (0, _assetLoader.AssetType).Audio,
        path: "assets/sounds/pick_up.mp3"
    },
    {
        type: (0, _assetLoader.AssetType).Audio,
        path: "assets/sounds/place.mp3"
    },
    {
        type: (0, _assetLoader.AssetType).Audio,
        path: "assets/sounds/swap_hands.mp3"
    },
    {
        type: (0, _assetLoader.AssetType).Audio,
        path: "assets/sounds/decline.mp3"
    }
]);
(async ()=>{
...
},{"./components":"hVzNr","./systems/controllable":"6hz4e","./engine/ecs":"bTIAG","./systems/render":"lpuAS","./helpers":"e7qJp","./systems/walking":"jMNjN","./systems/place":"5rRAM","./systems/keyup":"gd8Fk","./systems/health_bar":"eAFUA","./systems/weapon":"el55c","./engine/asset_loader":"lAt7z","@parcel/transformer-js/src/esmodule-helpers.js":"b4oyH","./templates/player":"i9IbW","./entity_gen":"ehzcX","./map_gen":"fQkPH","./systems/follow":"0Q7DK","./systems/click":"1JXm7","./systems/particles":"d5Qwy","./systems/respawn":"ip8yw","./systems/hunt":"82DPj"}],"hVzNr":[function(require,module,exports) {
/* 
 * components.ts
 *
...
parcelHelpers.export(exports, "HoldableComponent", ()=>HoldableComponent);
parcelHelpers.export(exports, "FollowComponent", ()=>FollowComponent);
parcelHelpers.export(exports, "ParticleColorComponent", ()=>ParticleColorComponent);
parcelHelpers.export(exports, "HiddenComponent", ()=>HiddenComponent);
parcelHelpers.export(exports, "RespawnableComponent", ()=>RespawnableComponent);
parcelHelpers.export(exports, "HunterComponent", ()=>HunterComponent);
var _ecs = require("./engine/ecs");
var _particle = require("./engine/particle");
var _helpers = require("./helpers");
...
class HealthComponent {
    ...
    #game;
    #entity;
    constructor(maxHealth, game, entity){
    ...
    damage(amount) {
        ...
        if (this.health === 0) {
            if (this.#entity === this.#game.player) ;
                ...
                if (this.#game.ecs.hasComponent(this.#entity, ParticleColorComponent)) (0, _particle.Particle).createBurst(this.#game, 17, 17, this.#game.ecs.getComponent(this.#entity, PositionComponent).getCentre(this.#game.tileSize), 0.08, 0.997, this.#game.ecs.getComponent(this.#entity, ParticleColorComponent).color);
                if (this.#game.ecs.hasComponent(this.#entity, RespawnableComponent)) {
                    ...
                    respawnable.timeUntilRespawn = (0, _helpers.randInt)(...respawnable.timeUntilRespawnRange);
                    this.#game.toRespawn.push(this.#entity);
                } else this.#game.ecs.removeEntity(this.#entity);
            }
        }
    }
}
...
class FollowComponent {
    randomWalkAngle = Math.random() * Math.PI * 2;
    timeOflastAngleChange = 0;
    constructor(target, maxTiles){
        this.target = target;
...
class RespawnableComponent {
    constructor(timeUntilRespawnRange){
...
class HunterComponent {
    timeOfLastHit = 0;
    timeUntilNextHit = 0;
    constructor(target, timeBetweenHitsRange){
        this.target = target;
        this.timeBetweenHitsRange = timeBetweenHitsRange;
    }
}

},{"./engine/ecs":"bTIAG","./helpers":"e7qJp","@parcel/transformer-js/src/esmodule-helpers.js":"b4oyH","./engine/particle":"bfx3U"}],"bTIAG":[function(require,module,exports) {
/* 
 * engine/ecs.ts
 *
...
(function(SystemTrigger) {
    ...
    SystemTrigger[SystemTrigger["Hit"] = 5] = "Hit";
...
class SystemManager {
    ...
    updateSystems(trigger) {
        ...
        for (const system of systems)for (const entity of this.game.ecs.entitiesWithComponents(this.game.roomAt(this.game.playerRoomPos), system.requiredComponents))system.update(this.game, entity);
    }
}
class ECS {
    #entities = [];
    ...
    get entities() {
        return this.#entities.filter((entity)=>!(0, _helpers.isHidden)(this, entity));
    }
    ...
    removeComponent(entity, component) {
        this.componentManagers.get(component).removeComponent(entity);
    }
...
parcelHelpers.export(exports, "cloneAudio", ()=>cloneAudio);
parcelHelpers.export(exports, "tryMove", ()=>tryMove);
parcelHelpers.export(exports, "setRandomEntityPos", ()=>setRandomEntityPos);
...
const anyHitboxesCollide = (game, entity, room = game.roomAt(game.playerRoomPos))=>{
    const position = game.ecs.getComponent(entity, _components.PositionComponent);
    if (game.ecs.hasComponent(entity, _components.HitboxComponent)) return room.entities.some((otherEntity)=>{
        ...
        const lhHitbox = game.ecs.getComponent(game.leftHandItemBox, _components.HitboxComponent).getActualHitbox(game.ecs.getComponent(game.leftHandItemBox, _components.PositionComponent));
        const rhHitbox = game.ecs.getComponent(game.rightHandItemBox, _components.HitboxComponent).getActualHitbox(game.ecs.getComponent(game.rightHandItemBox, _components.PositionComponent));
        // add a temporary hitbox
        game.ecs.addComponent(entity, _components.HitboxComponent, [
        ...
        game.ecs.removeComponent(entity, _components.HitboxComponent);
        return ret;
    }
};
const attemptPlace = (game, hands, pos)=>{
    ...
    const itemPosition = game.ecs.getComponent(item, _components.PositionComponent);
    ...
    if (anyHitboxesCollide(game, item)) {
        ...
        game.ecs.entitiesWithComponents(game.roomAt(game.playerRoomPos), [
            _components.WalkingComponent
...
const tryMove = (game, entity)=>{
    ...
    if (anyHitboxesCollide(game, entity) || // if the entity is an NPC, don't let it go near the edge
    entity !== game.player && (position.pixels.x < game.tileSize / 2 || position.pixels.x > game.canvas.width - game.tileSize * 1.5)) position.pixels.x -= speedX;
    // same thing with y speed
    position.pixels.y += speedY;
    if (anyHitboxesCollide(game, entity) || entity !== game.player && (position.pixels.y < game.tileSize / 2 || position.pixels.y > game.canvas.height - game.tileSize * 1.5)) position.pixels.y -= speedY;
};
const setRandomEntityPos = (game, room, entity)=>{
    let pixelPos;
    do {
        // set position on tile grid then add random offset
        pixelPos = new Vec((randInt(2, game.roomSize.x - 3) + Math.random() - .5) * game.tileSize, (randInt(2, game.roomSize.y - 3) + Math.random() - .5) * game.tileSize);
...
const isHidden = (ecs, entity)=>{
    return ecs.hasComponent(entity, _components.HiddenComponent);
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"b4oyH","./components":"hVzNr"}],"bfx3U":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Particle", ()=>Particle);
class Particle {
    constructor(pos, angle, speed, friction, color){
        this.pos = pos;
        this.angle = angle;
        this.speed = speed;
    ...
    static createBurst(game, count, delay, pos, speed, friction, color) {
        for(let i = 0; i < count; i++)setTimeout(()=>{
            game.particles.push(new Particle(pos, Math.random() * Math.PI * 2, speed * (.75 + Math.random() * .5), friction, color));
        }, delay * i);
    }
}
...
exports.default = ControllableSystem;
    ...
    constructor(){
        super([
            ...
            if (speed.speedX === 0 && speed.speedY === 0) image.frame.y = 0; // top row of spritesheet
                ...
                image.frame.y = 0;
                if (angle > -5 * Math.PI / 8 && angle < -3 * Math.PI / 8) image.frame.y = 16;
                else if (angle >= -3 * Math.PI / 8 && angle <= 3 * Math.PI / 8) image.frame.y = 48;
                else if (angle <= -5 * Math.PI / 8 || angle >= 5 * Math.PI / 8) image.frame.y = 32;
            }
            // move the entity (but don't move if there's a hitbox in the way)
            (0, _helpers.tryMove)(game, entity);
            // if moving
            if (speed.speedX !== 0 || speed.speedY !== 0) {
                ...
                if (performance.now() - image.timeOflastFrameChange >= timeBetweenFrames) {
                    ...
                    if (image.frame.x === 16 || image.frame.x === 48) {
                        const clone = (0, _helpers.cloneAudio)(game.getAudio("footstep"));
            ...
            } else // reset frame to default
            image.frame.x = 0;
            const walkingComponent = game.ecs.getComponent(entity, _components.WalkingComponent);
            // if the entity has health and can get tired by walking
            if (game.ecs.hasComponent(entity, _components.HealthComponent) && walkingComponent.canGetTired) {
                const health = game.ecs.getComponent(entity, _components.HealthComponent);
                if (speed.currentVelocity !== 0) // remove health based on speed (1/120th of the velocity per tick)
                health.damage(speed.currentVelocity / 120);
                else // heal if resting (1/3000th of the max health per tick)
...
exports.default = WalkingSystem;

},{"../components":"hVzNr","../engine/ecs":"bTIAG","../helpers":"e7qJp","@parcel/transformer-js/src/esmodule-helpers.js":"b4oyH"}],"5rRAM":[function(require,module,exports) {
/* 
 * systems/place.ts
 *
...
class PlaceSystem extends (0, _ecs.System) {
    constructor(){
        super([
            ...
            (0, _helpers.attemptPlace)(game, hands, game.lastClickPos.shifted(new (0, _helpers.Vec)(-game.tileSize / 2, -game.tileSize / 2)));
        });
    }
}
exports.default = PlaceSystem;
    ...
    constructor(){
        super([
            ...
            if (game.keyReleased === "f") {
                ...
                if (hands.leftHand || hands.rightHand) (0, _helpers.cloneAudio)(game.getAudio("swap_hands")).play();
            }
            ...
            if (game.keyReleased === "q") {
                ...
                const dropVecs = {
                    "left": new (0, _helpers.Vec)(-1, 0),
                    "right": new (0, _helpers.Vec)(1, 0),
                    "above": new (0, _helpers.Vec)(0, -1),
                    "below": new (0, _helpers.Vec)(0, 1)
                };
                // chose a vector based on movement direction so that the item is dropped behind the player
                const vec = dropVecs[game.keys["d"] ? "left" : game.keys["a"] ? "right" : game.keys["w"] ? "below" : game.keys["s"] ? "above" : null];
                const drop = ()=>{
                    /*
                ...
                if (vec) {
                    const placeSuceeded = (0, _helpers.attemptPlace)(game, hands, thisPos.pixels.shifted(vec.multiplied(game.tileSize)));
...
exports.default = KeyUpSystem;

},{"../components":"hVzNr","../engine/ecs":"bTIAG","../helpers":"e7qJp","@parcel/transformer-js/src/esmodule-helpers.js":"b4oyH"}],"eAFUA":[function(require,module,exports) {
/* 
...
exports.default = HealthBarSystem;

},{"../components":"hVzNr","../engine/ecs":"bTIAG","@parcel/transformer-js/src/esmodule-helpers.js":"b4oyH"}],"el55c":[function(require,module,exports) {
/* 
 * systems/weapon.ts
 * 
...
exports.default = WeaponSystem;

},{"../components":"hVzNr","../engine/ecs":"bTIAG","@parcel/transformer-js/src/esmodule-helpers.js":"b4oyH"}],"lAt7z":[function(require,module,exports) {
/* 
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"b4oyH"}],"i9IbW":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "newPlayerEntity", ()=>newPlayerEntity);
var _components = require("../components");
var _helpers = require("../helpers");
const newPlayerEntity = (game, pos)=>{
    const player = game.ecs.createEntity();
    game.ecs.addComponent(player, _components.PositionComponent, [
        pos,
        new (0, _helpers.Vec)(Math.floor(game.roomCount.x / 2), Math.floor(game.roomCount.y / 2))
    ]);
    game.ecs.addComponent(player, _components.ImageComponent, [
        game.getImage("player"),
        new (0, _helpers.Rect)(0, 0, 16, 16)
    ]);
    game.ecs.addComponent(player, _components.SpeedComponent, [
        2
    ]);
    game.ecs.addComponent(player, _components.WalkingComponent, [
        true
    ]);
    game.ecs.addComponent(player, _components.ControllableComponent);
    game.ecs.addComponent(player, _components.HandsComponent, [
        null,
        null
    ]);
    game.ecs.addComponent(player, _components.HealthComponent, [
        100,
        game,
        player
    ]);
    game.ecs.addComponent(player, _components.HitboxComponent, [
        (0, _helpers.Rect).fromVecs(new (0, _helpers.Vec)(2, 0).scaled(16, game.tileSize).shifted(new (0, _helpers.Vec)(0, 2)), new (0, _helpers.Vec)(12, 16).scaled(16, game.tileSize).shifted(new (0, _helpers.Vec)(0, -2)))
    ]);
    return player;
};

},{"../components":"hVzNr","../helpers":"e7qJp","@parcel/transformer-js/src/esmodule-helpers.js":"b4oyH"}],"ehzcX":[function(require,module,exports) {
/* 
 * engine/itemgen.ts
 *
 ...
 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "addEntities", ()=>addEntities);
var _components = require("./components");
var _helpers = require("./helpers");
var _item = require("./templates/item");
var _zombie = require("./templates/zombie");
const addEntities = (game)=>{
    for (const room of game.rooms){
        // 5-10 logs in each room
        for(let i = 0; i < (0, _helpers.randInt)(5, 10); i++)(0, _item.newItemEntity)(game, room, game.getImage("items"), new (0, _helpers.Rect)(0, 0, 16, 16), new (0, _helpers.Rect)(1, 1, game.tileSize - 1, game.tileSize - 1));
        for(let i = 0; i < Math.round(game.level / 3); i++)(0, _zombie.newZombieEntity)(game, room);
    }
    // add a stick in the room the player starts in
    const stick = (0, _item.newItemEntity)(game, game.roomAt(game.playerRoomPos), game.getImage("items"), new (0, _helpers.Rect)(0, 16, 16, 16));
    game.ecs.addComponent(stick, _components.WeaponComponent, [
        5
    ]);
};

},{"./components":"hVzNr","./helpers":"e7qJp","./templates/item":"cfzeL","@parcel/transformer-js/src/esmodule-helpers.js":"b4oyH","./templates/zombie":"lFnzG"}],"cfzeL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "newItemEntity", ()=>newItemEntity);
var _components = require("../components");
var _helpers = require("../helpers");
const newItemEntity = (game, room, image, frame, hitbox)=>{
    const entity = game.ecs.createEntity();
    // add hitbox if provided
    if (hitbox) game.ecs.addComponent(entity, _components.HitboxComponent, [
        hitbox
    ]);
    (0, _helpers.setRandomEntityPos)(game, room, entity);
...
},{"../components":"hVzNr","../helpers":"e7qJp","@parcel/transformer-js/src/esmodule-helpers.js":"b4oyH"}],"lFnzG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "newZombieEntity", ()=>newZombieEntity);
var _components = require("../components");
var _helpers = require("../helpers");
const newZombieEntity = (game, room)=>{
    const zombie = game.ecs.createEntity();
    game.ecs.addComponent(zombie, _components.ImageComponent, [
        game.getImage("zombie"),
        new (0, _helpers.Rect)(0, 0, 16, 16)
    ]);
    game.ecs.addComponent(zombie, _components.HitboxComponent, [
        (0, _helpers.Rect).fromVecs(new (0, _helpers.Vec)(2, 0).scaled(16, game.tileSize).shifted(new (0, _helpers.Vec)(0, 2)), new (0, _helpers.Vec)(12, 16).scaled(16, game.tileSize).shifted(new (0, _helpers.Vec)(0, -2)))
    ]);
    (0, _helpers.setRandomEntityPos)(game, room, zombie);
    // TODO: make relative to level
    game.ecs.addComponent(zombie, _components.SpeedComponent, [
        1
    ]);
    game.ecs.addComponent(zombie, _components.FollowComponent, [
        game.player,
        10
    ]);
    game.ecs.addComponent(zombie, _components.HealthComponent, [
        50,
        game,
        zombie
    ]);
    game.ecs.addComponent(zombie, _components.HunterComponent, [
        game.player,
        [
            1000,
            2000
    ...
    game.ecs.addComponent(zombie, _components.RespawnableComponent, [
        [
            5000,
            10000
        ]
    ...
    game.ecs.addComponent(stick, _components.ImageComponent, [
        game.getImage("items"),
        new (0, _helpers.Rect)(0, 16, 16, 16)
    ]);
    game.ecs.addComponent(stick, _components.PositionComponent, [
        new (0, _helpers.Vec)(game.canvas.width, game.canvas.height),
        room.pos
    ]);
    game.ecs.addComponent(stick, _components.HoldableComponent);
    game.ecs.addComponent(stick, _components.WeaponComponent, [
        5
    ]);
    game.ecs.addComponent(zombie, _components.HandsComponent, [
        stick,
        null
    ]);
    game.ecs.addComponent(zombie, _components.WalkingComponent, [
        false
    ]);
    game.ecs.addComponent(zombie, _components.ParticleColorComponent, [
        "#bb0000"
    ]);
};

},{"../components":"hVzNr","../helpers":"e7qJp","@parcel/transformer-js/src/esmodule-helpers.js":"b4oyH"}],"fQkPH":[function(require,module,exports) {
/* 
 * engine/mapgen.ts
 *
...
},{"./components":"hVzNr","./helpers":"e7qJp","./engine/room":"lr0cD","@parcel/transformer-js/src/esmodule-helpers.js":"b4oyH"}],"lr0cD":[function(require,module,exports) {
/*
 * engine/room.ts
 *
...
class Room {
    ...
    render() {
        ...
        for(let y = 0; y < this.game.roomSize.y; y++)for(let x = 0; x < this.game.roomSize.x; x++){
            ...
            this.game.ctx.drawImage(this.game.getImage("tiles"), // source x, y, width, and height
    ...
    get entities() {
        ...
        return [
            this.game.leftHandItemBox,
            this.game.rightHandItemBox
        ].concat(this.game.ecs.entities.filter((entity)=>{
...
},{"../components":"hVzNr","../helpers":"e7qJp","@parcel/transformer-js/src/esmodule-helpers.js":"b4oyH"}],"0Q7DK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _components = require("../components");
var _ecs = require("../engine/ecs");
class Followsystem extends (0, _ecs.System) {
    constructor(){
        super([
            _components.FollowComponent,
            _components.PositionComponent
        ], (0, _ecs.SystemTrigger).Tick, (game, entity)=>{
            const followComponent = game.ecs.getComponent(entity, _components.FollowComponent);
            // position of the entity with the follow component
            const position = game.ecs.getComponent(entity, _components.PositionComponent);
            // position of the entity being followed
            const targetPosition = game.ecs.getComponent(followComponent.target, _components.PositionComponent);
            ...
            if (followComponent.target === game.player) {
                const sneaking = game.ecs.getComponent(game.player, _components.ControllableComponent).sneaking;
            ...
            if (dist < maxDistance) {
                ...
                if (performance.now() - followComponent.timeOflastAngleChange > 3000 && Math.random() < .1) {
            ...
            if (game.keys["h"]) {
                game.ctx.beginPath();
                game.ctx.moveTo(position.pixels.x + game.tileSize / 2, position.pixels.y + game.tileSize / 2);
                if (dist < maxDistance) game.ctx.lineTo(targetPosition.pixels.x + game.tileSize / 2, targetPosition.pixels.y + game.tileSize / 2);
                else game.ctx.lineTo(position.pixels.x + Math.cos(followComponent.randomWalkAngle) * game.canvas.width, position.pixels.y + Math.sin(followComponent.randomWalkAngle) * game.canvas.width);
...
exports.default = Followsystem;

},{"../components":"hVzNr","../engine/ecs":"bTIAG","@parcel/transformer-js/src/esmodule-helpers.js":"b4oyH"}],"1JXm7":[function(require,module,exports) {
/*
 * systems/click.ts
 *
...
class ClickSystem extends (0, _ecs.System) {
    constructor(){
        super([
            _components.ControllableComponent,
            _components.PositionComponent,
             ...
             */ const entityToHit = game.roomAt(game.playerRoomPos).entities.slice().reverse().find((otherEntity)=>{
                ...
                if (hasTempHitbox) game.ecs.removeComponent(otherEntity, _components.HitboxComponent);
                return ret;
            });
            // use hit function
            (0, _hit.hit)(game, entity, entityToHit ?? null);
        });
    }
}
exports.default = ClickSystem;

},{"../components":"hVzNr","../engine/ecs":"bTIAG","../helpers":"e7qJp","@parcel/transformer-js/src/esmodule-helpers.js":"b4oyH","../hit":"b71FR"}],"b71FR":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "hit", ()=>hit);
var _components = require("./components");
var _helpers = require("./helpers");
const hit = (game, hitter, entityToHit)=>{
    const hands = game.ecs.getComponent(hitter, _components.HandsComponent);
    // try to get weapon entity from right hand, otherwise try left hand or null
    const weaponEntity = game.ecs.hasComponent(hands.rightHand, _components.WeaponComponent) ? hands.rightHand : game.ecs.hasComponent(hands.leftHand, _components.WeaponComponent) ? hands.leftHand : null;
    if (weaponEntity) {
        ...
        const holderPosition = game.ecs.getComponent(hitter, _components.PositionComponent);
        const toHitPosition = game.ecs.getComponent(entityToHit, _components.PositionComponent);
        weaponComponent.startAngle = holderPosition.pixels.angleTo(toHitPosition?.pixels || game.lastClickPos);
    ...
    if (entityToHit !== null) {
        if (game.ecs.hasComponent(entityToHit, _components.HoldableComponent)) {
            if (hands.hasSpace()) {
                ...
                if (hitter === game.player) itemPosComponent.pixels = hands.leftHand === item ? game.leftHandItemPos : game.rightHandItemPos;
                else // TODO: use HiddenComponent instead
                itemPosComponent.pixels = new (0, _helpers.Vec)(0, 0);
                // bind the item's room pos to the position of the entity that picked it up
                itemPosComponent.room = game.ecs.getComponent(hitter, _components.PositionComponent).room;
                (0, _helpers.cloneAudio)(game.getAudio("pick_up")).play();
            } else (0, _helpers.cloneAudio)(game.getAudio("decline")).play();
        } else if (weaponEntity && game.ecs.hasComponent(entityToHit, _components.HealthComponent)) {
            const healthComponent = game.ecs.getComponent(entityToHit, _components.HealthComponent);
            const damage = game.ecs.getComponent(weaponEntity, _components.WeaponComponent).damage;
            healthComponent.damage(damage);
        }
    }
};

},{"./components":"hVzNr","./helpers":"e7qJp","@parcel/transformer-js/src/esmodule-helpers.js":"b4oyH"}],"d5Qwy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _ecs = require("../engine/ecs");
var _helpers = require("../helpers");
class ParticleSystem extends (0, _ecs.System) {
    constructor(){
        super([], (0, _ecs.SystemTrigger).Tick, (game)=>{
            for (const [index, particle] of game.particles.entries()){
                // move particle
                particle.pos = particle.pos.shifted(new (0, _helpers.Vec)(particle.speed * Math.cos(particle.angle), particle.speed * Math.sin(particle.angle)));
                particle.speed *= particle.friction;
                // if the particle has effectively stopped, remove it
                if (particle.speed < 0.004) game.particles.splice(index, 1);
                // render particle
                game.ctx.fillStyle = particle.color;
                game.ctx.fillRect(particle.pos.x, particle.pos.y, 5, 5 // 5x5 pixels
                );
            }
        });
    }
...
},{"../engine/ecs":"bTIAG","../helpers":"e7qJp","@parcel/transformer-js/src/esmodule-helpers.js":"b4oyH"}],"ip8yw":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _components = require("../components");
var _ecs = require("../engine/ecs");
var _helpers = require("../helpers");
class RespawnSystem extends (0, _ecs.System) {
    constructor(){
        super([], (0, _ecs.SystemTrigger).Tick, (game)=>{
            for (const entity of game.toRespawn){
                const respawnable = game.ecs.getComponent(entity, _components.RespawnableComponent);
                ...
                if (performance.now() - respawnable.timeOfDeath > respawnable.timeUntilRespawn) {
                    // un-hide the entity
                    game.ecs.removeComponent(entity, _components.HiddenComponent);
                    // heal the entity to full health
                    const health = game.ecs.getComponent(entity, _components.HealthComponent);
                    health.heal(health.maxHealth);
                    // if the entity is colliding with anything, move it to a random position
                    const position = game.ecs.getComponent(entity, _components.PositionComponent);
                    if ((0, _helpers.anyHitboxesCollide)(game, entity)) (0, _helpers.setRandomEntityPos)(game, game.roomAt(position.room), entity);
...
exports.default = RespawnSystem;

},{"../engine/ecs":"bTIAG","@parcel/transformer-js/src/esmodule-helpers.js":"b4oyH","../components":"hVzNr","../helpers":"e7qJp"}],"82DPj":[function(require,module,exports) {
/* 
 * systems/hunt.ts
 *
...
var _helpers = require("../helpers");
var _hit = require("../hit");
class HuntSystem extends (0, _ecs.System) {
    constructor(){
        super([
            _components.HunterComponent,
            _components.PositionComponent
        ], (0, _ecs.SystemTrigger).Tick, (game, entity)=>{
            const hunterComponent = game.ecs.getComponent(entity, _components.HunterComponent);
            // make sure the entity has a target
            if (hunterComponent.target === null) return;
            const hunterPos = game.ecs.getComponent(entity, _components.PositionComponent);
            const targetPos = game.ecs.getComponent(hunterComponent.target, _components.PositionComponent);
            // distance to target
            const distToTarget = hunterPos.pixels.distTo(targetPos.pixels);
            if (distToTarget < game.tileSize * game.minHitDist && performance.now() - hunterComponent.timeOfLastHit > hunterComponent.timeUntilNextHit) {
                // set the time of the last hit to now
                hunterComponent.timeOfLastHit = performance.now();
                // set a new random time until the next hit
                hunterComponent.timeUntilNextHit = (0, _helpers.randInt)(...hunterComponent.timeBetweenHitsRange);
                // hit the target
                (0, _hit.hit)(game, entity, hunterComponent.target);
            }
        });
    }
}
exports.default = HuntSystem;

},{"../components":"hVzNr","../engine/ecs":"bTIAG","../helpers":"e7qJp","../hit":"b71FR","@parcel/transformer-js/src/esmodule-helpers.js":"b4oyH"}]},["55rT5","2G5F2"], "2G5F2", "parcelRequirec2fe")
